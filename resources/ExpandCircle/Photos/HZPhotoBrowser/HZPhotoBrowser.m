...
- (void)showPhotoBrowser
{
    ...
    if (self.ttSourceViews.count > _currentImageIndex) {
        sourceView = self.ttSourceViews[_currentImageIndex];
    }else{
        sourceView = self.ttSourceView;
    }
    if (sourceView) {
...
- (void)addToolbars
{
    ...
    [self.pageControl mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerY.equalTo(self.view.mas_bottom).offset(-24);
    }];
